...
Текущий проект пуст. Чтобы получить доступ к процессорной системе ARM, добавим встроенный исходник в проект Vivado, создавая блочный дизайн при помощи IP-интегратора (IP-интегратор).

### **Обобщенная инструкция:**

Создайте блочный дизайн и добавьте туда процессорное ядро.

### **Пошаговая инструкция:**

1. В области окна *Flow Navigator* найдите меню *IP Integrator*. В нем выберите пункт **Create block design**.
![Создание блочного дизайна](./resources/Create%20Block%20Design.png)
...
![Добавить IP](./resources/Add%20IP.png)
...
![СФ-блок процессорной системы Zynq](./resources/Zynq%20Processing%20System.png)

5. Диаграмма теперь содержит IP-блок *processing_system7_0*. В зеленой навигационной панели можно увидеть сообщение от *Designer Assistant*. В блочном дизайне большинство IP-блоков может быть автоматически соединено при выборе *Run Block Automation*. Нажмите на **Run Block Automation**, чтобы выполнить автоматическое соединение на процессорном ядре ARM.
![Запустить автоматическое соединение блоков](./resources/Run%20Block%20Automation.png)

6. Запущенное автоматическое средство самостоятельно определяет внешние интерфейсы *DDR* и *FIXED_IO*, которые необходимо соединить. ????FIXED_IO - это интерфейсы I/O, предназначенные для внутренних вшитых периферийных устройств в процессорной системе Zynq, включая UART, Ethernet, USB и другие IP. Их коснемся позже. Сейчас нажмите кнопку **Ok** для запуска средства автоматической установки соединений. Средство определяет эти порты, как внешние интерфейсы. Блочный дизайн может быть частью большего дизайна, поэтому его внешние интерфейсы обязательно должны быть определены.
![Соединение внешних интерфейсов](./resources/Click%20OK%20to%20connect%20external%20interfaces.png)
Два внешних порта теперь соединены с IP-блоком.
![Внешнее соединение портов](./resources/External%20Port%20Connections.png)

7. Нажмите кнопку **Save Block Design** в верхней панели Vivado для сохранения блочного дизайна.
![Сохранение блочного дизайна](./resources/Save%20Block%20Design.png)

8. На данный момент Процессорная система ZYNQ7 полностью не сконфигурирована. Чтобы настроить нашу систему два раза нажмите на **ZYNQ7 Processing System** IP-блок. Большинство IP может быть кастомизировано таким образом.
![Кастомизация IP](./resources/Double%20Click%20on%20IP%20to%20customize%20the%20IP.png)
...
![Рекастомизация процессорной системы](./resources/Re-Customize%20IP%20window%20for%20the%20Zynq%20PS.png)
...
[www.picozed.org](www.picozed.org)

[www.zedboard.org](www.zedboard.org)

[www.xilinx.com/zynq](www.xilinx.com/zynq)

[www.xilinx.com/zynq](www.xilinx.com/sdk)

[www.xilinx.com/vivado](www.xilinx.com/vivado)

[www.xilinx.com/support/documentation/sw_manuals/ug949-vivado-design-methodology.pdf](www.xilinx.com/support/documentation/sw_manuals/ug949-vivado-design-methodology.pdf)

[www.xilinx.com/support/documentation/sw_manuals/ug1046-ultrafast-design-methodology-guide.pdf](www.xilinx.com/support/documentation/sw_manuals/ug1046-ultrafast-design-methodology-guide.pdf)
